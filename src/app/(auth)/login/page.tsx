      ...
      <div className="w-full animate-fade-up" style={{ maxWidth: 460, marginLeft: 'auto', marginRight: 'auto' }}>
        ...
        <form onSubmit={handleSubmit} className="card p-10 space-y-6">
          ...
          <div>
            ...
            <input type="password" value={password} onChange={e => setPassword(e.target.value)} required className="w-full px-5 py-4 rounded-xl text-base text-white transition-all" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border)' }} placeholder="••••••••" />
          </div>
